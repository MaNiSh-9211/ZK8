...
export function InspiredFlightModel({ scale = 1, ...props }: { scale?: number; [key: string]: any }) {
  const group = useRef<THREE.Group>(null);
  const { scene } = useGLTF('/models/inspired-flight-if1200a.glb');
...
useGLTF.preload('/models/inspired-flight-if1200a.glb');
